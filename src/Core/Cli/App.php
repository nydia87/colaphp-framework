...
class App
{
	...
	private static function init(): void
	{
		...
		// 分组配置
		if (is_file(APP_PATH . GROUP_NAME . DIRECTORY_SEPARATOR . 'config.php')) {
			Config::load(APP_PATH . GROUP_NAME . DIRECTORY_SEPARATOR . 'config.php');
		}
		if (is_file(APP_PATH . GROUP_NAME . DIRECTORY_SEPARATOR . 'function.php')) {
			include APP_PATH . GROUP_NAME . DIRECTORY_SEPARATOR . 'function.php';
		}
	}
